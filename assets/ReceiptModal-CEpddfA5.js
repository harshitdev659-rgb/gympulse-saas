import{r as v,j as t}from"./vendor-react-Ds7D3P6J.js";import{b as _,a as $,M as S,B as z,f as m}from"./index-CDci4Cry.js";import{a1 as C,E as D,C as M}from"./vendor-icons-CCqp1nk0.js";function T({gym:i,payment:s,member:a}){const l=(i==null?void 0:i.name)||"GymPulse Fitness Facility",o=(i==null?void 0:i.email)||"",e=(i==null?void 0:i.phone)||"",d=(i==null?void 0:i.address)||"",x=(i==null?void 0:i.currency)||"INR",p=(s==null?void 0:s.receipt_number)||`INV-${String((s==null?void 0:s.id)||"0").padStart(6,"0")}`,n=s!=null&&s.payment_date?new Date(s.payment_date).toLocaleString():new Date().toLocaleString(),u=a?`${a.first_name||""} ${a.last_name||""}`.trim():(s==null?void 0:s.member_name)||"Valued Member",g=(a==null?void 0:a.phone)||(s==null?void 0:s.member_phone)||"N/A",b=(a==null?void 0:a.email)||(s==null?void 0:s.member_email)||"N/A",h=Number((s==null?void 0:s.amount)||0).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),f=((s==null?void 0:s.payment_method)||"Cash").toUpperCase(),N=((s==null?void 0:s.status)||"Completed").toUpperCase(),k=(s==null?void 0:s.notes)||"Gym Membership & Facility Access",w=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
