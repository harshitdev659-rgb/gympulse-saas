import{r as $,j as t}from"./vendor-react-Ds7D3P6J.js";import{b as M,a as S,M as z,B as D,f as g}from"./index-B_SBqlBs.js";import{Y as A,a3 as T,E as R,C as F}from"./vendor-icons-CGUJD458.js";function E({gym:a,payment:s,member:i}){const n=(a==null?void 0:a.name)||"GymPulse Fitness Facility",o=(a==null?void 0:a.email)||"",e=(a==null?void 0:a.phone)||"",x=(a==null?void 0:a.address)||"",b=(a==null?void 0:a.currency)||"INR",m=(s==null?void 0:s.receipt_number)||`INV-${String((s==null?void 0:s.id)||"0").padStart(6,"0")}`,d=s!=null&&s.payment_date?new Date(s.payment_date).toLocaleString():new Date().toLocaleString(),N=i?`${i.first_name||""} ${i.last_name||""}`.trim():(s==null?void 0:s.member_name)||"Valued Member",v=(i==null?void 0:i.phone)||(s==null?void 0:s.member_phone)||"N/A",f=(i==null?void 0:i.email)||(s==null?void 0:s.member_email)||"N/A",p=Number((s==null?void 0:s.amount)||0).toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2}),j=((s==null?void 0:s.payment_method)||"Cash").toUpperCase(),u=((s==null?void 0:s.status)||"Completed").toUpperCase(),c=(s==null?void 0:s.notes)||"Gym Membership & Facility Access",w=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
