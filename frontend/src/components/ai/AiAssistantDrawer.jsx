      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col border-l border-slate-200">
                    ...
                    <div className="mt-3 pt-3 border-t border-slate-100 flex flex-wrap gap-2">
                      {m.actions.map((act, i) => (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-brand-50 text-brand-700 hover:bg-brand-100 border border-brand-200/60 transition-colors flex items-center gap-1"
                        >
                          {act.label}
          ...
          <div className="p-2 border-t border-slate-100 bg-white flex items-center gap-2 overflow-x-auto text-xs no-scrollbar">
            <span className="text-[11px] font-bold text-slate-400 pl-2">Try:</span>
            <button
              onClick={() => handleSend("What was our revenue this month?")}
              className="whitespace-nowrap px-2.5 py-1 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-medium"
            >
              Revenue?
            </button>
            <button
          ...
          {isListening && (
            <div className="px-4 py-2.5 bg-rose-50 border-t border-rose-200 text-rose-800 text-xs flex items-center justify-between animate-pulse">
          ...
          {isTranscribing && (
            <div className="px-4 py-2 bg-indigo-50 border-t border-indigo-200 text-indigo-800 text-xs flex items-center gap-2">
              <RefreshCw className="w-3.5 h-3.5 animate-spin text-brand-600" />
          ...
          >
            <input
              ...
              className={`flex-1 px-4 py-2.5 rounded-xl border text-sm transition-all focus:outline-none focus:ring-2 ${
                isListening
                  ? 'border-rose-400 ring-2 ring-rose-300/50 bg-rose-50/30 placeholder-rose-500 font-medium'
