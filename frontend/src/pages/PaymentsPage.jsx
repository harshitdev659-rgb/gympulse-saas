              ...
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={7} className="py-12 text-center text-slate-400">
                    ...
                    <p className="text-xs text-slate-400 mt-1">Record a new payment to generate an invoice.</p>
                  </td>
                </tr>
              ) : (
                payments.map((p) => (
                  <tr key={p.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      ...
                      {p.plan_name && (
                        <div className="text-xs text-slate-500">{p.plan_name}</div>
                      )}
                    </td>
                    ...
                    <td className="py-4 px-6 text-xs capitalize text-slate-600 font-medium">
                      {p.payment_method}
                    </td>
